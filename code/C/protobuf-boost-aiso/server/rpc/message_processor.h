...
#ifndef KYDROID_RPC_MESSAGE_PROCESSOR_H_
#define KYDROID_RPC_MESSAGE_PROCESSOR_H_
...
class Invocation {
 public:
  Invocation(kydroid::protobuf::rpc::Invocation const& invocation)
 ...
 private:
  kydroid::protobuf::rpc::Invocation const& invocation_;
};
