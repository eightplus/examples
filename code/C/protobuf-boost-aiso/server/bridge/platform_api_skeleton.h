...
class PlatformApiSkeleton {
 public:
  ...
  void set_clipboard_data(kydroid::protobuf::bridge::ClipboardData const *request,
                          kydroid::protobuf::rpc::Void *response,
                          google::protobuf::Closure *done);
  void get_clipboard_data(kydroid::protobuf::rpc::Void const *request,
                          kydroid::protobuf::bridge::ClipboardData *response,
                          google::protobuf::Closure *done);

  void handle_boot_finished_event(
      const kydroid::protobuf::bridge::BootFinishedEvent &event);
  void handle_window_state_update_event(
      const kydroid::protobuf::bridge::WindowStateUpdateEvent &event);
  void handle_application_list_update_event(
      const kydroid::protobuf::bridge::ApplicationListUpdateEvent &event);

  void register_boot_finished_handler(const std::function<void()> &action);

 private:
  //std::shared_ptr<rpc::PendingCallCache> pending_calls_;
  //std::shared_ptr<KydroidPlatform> platform_;
