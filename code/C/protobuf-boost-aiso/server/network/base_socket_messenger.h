...
#ifndef KYDROID_NETWORK_BASE_SOCKET_MESSENGER_H_
#define KYDROID_NETWORK_BASE_SOCKET_MESSENGER_H_
...
public:
    ...
    void async_receive_msg(KydroidReadHandler const& handle,
